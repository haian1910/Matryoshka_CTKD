...
TEACHER_MODEL_PATH="/xxx/Dynamic_mapping_Distillation/outputs/LLM2Vec/sft/scitail/criterion=cross_entropy__lora-rank=16-alpha=32-dropout=0.1-bf16__epoch=2__bsz=16x1x1=16__lr=0.00001/epoch1_step1444_loss0.1227"
# data
...
CMD="torchrun ${DISTRIBUTED_ARGS} ${BASE_PATH}/SentencePair/matry_distillation.py ${OPTS}"
