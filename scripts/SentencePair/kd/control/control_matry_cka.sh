...
TEACHER_MODEL_PATH="/xxx/Dynamic_mapping_Distillation/outputs/LLM2Vec/sft/control/criterion=cross_entropy__lora-rank=256-alpha=16-dropout=0.1-bf16__epoch=3__bsz=4x1x1=4__lr=0.00001/epoch3_step5040_loss0.3079"
# data
DATASET=control
