...
TEACHER_MODEL_PATH="/xxx/Dynamic_mapping_Distillation/outputs/LLM2Vec/stsbenchmark/sft/criterion=sts_loss__lora-rank=256-alpha=16-dropout=0.1-bf16__epoch=5__bsz=4x1x1=4__lr=0.00001/epoch4_step5752_loss2.2994_pearson0.8373" # GẮN LINK MODEL CHECKPOINT VÀO ĐÂY
# data
