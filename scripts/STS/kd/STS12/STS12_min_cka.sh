...
TEACHER_MODEL_PATH="/xxx/Dynamic_mapping_Distillation/outputs/LLM2Vec/sft/STS12/criterion=sts_loss__lora-rank=256-alpha=16-dropout=0.1-bf16__epoch=5__bsz=4x1x1=4__lr=0.00001/epoch4_step2236_loss1.6073_pearson0.8316" # GẮN LINK MODEL CHECKPOINT VÀO ĐÂY
# data
DATASET=STS12
