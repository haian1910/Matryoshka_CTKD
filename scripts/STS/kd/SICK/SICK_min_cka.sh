...
TEACHER_MODEL_PATH="/xxx/Dynamic_mapping_Distillation/outputs/LLM2Vec/SICK/sft/criterion=sts_loss__lora-rank=256-alpha=16-dropout=0.1-bf16__epoch=10__bsz=4x1x1=4__lr=0.00001/epoch7_step7873_loss0.9858_pearson0.8734" # GẮN LINK MODEL CHECKPOINT VÀO ĐÂY
# data
DATASET=SICK
